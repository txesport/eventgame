...
<x-app-layout>
    ...
    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center mt-1">
                            ...
                            <button class="btn btn-sm btn-outline-secondary"
                                    onclick="copyToClipboard('{{ $group->invitation_code }}', this)">
                                <i class="bi bi-clipboard"></i>
                            </button>
                        </div>
                        <small class="text-muted">Partagez ce code pour inviter de nouveaux membres</small>
                    </div>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        <i class="bi bi-calendar3 text-success"></i> Événements
                    </h5>
    ...
    <!-- Chat du groupe en bas, pleine largeur -->
    <div class="row mt-5">
        <div class="col-12">
